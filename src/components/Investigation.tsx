                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                    <div className="h-64 w-full relative" dir="ltr">
                         <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                ...
                                <Legend 
                                    ...
                                    align="right"
                                    iconType="circle"
                                    wrapperStyle={{ fontSize: '12px', fontFamily: 'Heebo' }}
                                    formatter={(value, entry: any) => (
                                        <span className="text-slate-600 font-medium mr-2">{value}</span>
                                    )}
                                />
                            </PieChart>
                        </ResponsiveContainer>
                        ...
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none">
                            <span className="text-3xl font-bold text-slate-900 block font-mono tracking-tight">{totalAnomalies}</span>
                                    ...
                                    <td className="py-3 px-4">
                                        <div className="flex items-center justify-end gap-3">
                                            <span className={`font-bold font-mono ${
                                                row.percentage >= 80 ? 'text-emerald-600' : 
                                            ...
                                            <div className="w-24 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                                <div 
                                                    className={`h-full rounded-full ${
                                                        row.percentage >= 80 ? 'bg-emerald-500' : 
